...
export const activateThesisCoordinator = async (
  ...
  try {
    ...
    const response = await axios.post(
      `${import.meta.env.VITE_API_URL}/thesisCoordinator/toggle`,
      { user_id: userId },
      {
        headers: {
