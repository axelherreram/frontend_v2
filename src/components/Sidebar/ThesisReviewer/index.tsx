  ...
  return (
    <aside
      ...
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72 flex-col overflow-hidden
        bg-gradient-to-b from-[#1c1008] to-[#120b04]
    ...
    >
      ...
      <div className="px-5 py-3">
        <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold
          bg-orange-500/20 text-orange-300 border border-orange-500/30 tracking-wide uppercase">
          Revisor de Tesis
        </span>
      </div>
              ...
              <li key={to}>
                ...
                >
                  <span className={`flex-shrink-0 transition-transform duration-200 group-hover:scale-110
                    ${isActive ? 'text-white' : 'text-orange-400/70 group-hover:text-orange-300'}`}>
                    {icon}
                  </span>
                  <span>{label}</span>
